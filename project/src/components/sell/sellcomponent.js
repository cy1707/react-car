...
import * as actions from './sellAction'
            ...
            <div id="bigbox">
                ...
                <div className="sell_top">
                    ...
                    <div className="sell_input">
                        ...
                        <Link to="/order"><button className="x_btn1">预约卖车</button></Link>
                            ...
                            <ul className="carRecommendList" key={item.id} onTouchStart={this.cardetail.bind(this,item.id)}>
                                <li>
                                    ...
                                    <div className="carRecommendList_r">
                                        <a className="aa">{item.car_name}</a>
...
let mapStateToProps = (state) => {
    return {
        ajaxStatus: state.sell.status,
        ajaxResult: state.sell.result || []
    }
}

export default connect(mapStateToProps, actions)(SellComponent);
